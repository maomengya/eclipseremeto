...
public class TermXY implements Comparable<TermXY>, Addible<TermXY> 
{
    ...
    public TermXY(int coef, int xexp)                       //构造一项
    {
        this.coef = coef;
        this.xexp = xexp;
    }
    ...
    public int compareTo(TermXY term)                       //按x指数比较两项大小，实现Comparable<T>接口
    {
    ...
    public void add(TermXY term)                            //若指数相同，则系数相加；实现Addible<T>接口
    {
